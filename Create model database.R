...
# NB original version of this code did an EDA, looked at redundant variables, made plots of conv prob vs each predictor etc. See 'EDA&CreateModelDatabase_OBSOLETE.r'
...
#3. Data cleaning - for vars with lots of levels, combine levels together into something meaningful. Plus some other cleaning stuff ----
#__________________________________________________________________________________________________________________________________
...
#4. Create data base - one row per USER. *** Each row is randomly selected per user *** ---- 
#__________________________________________________________________________________________________________________________________
...
#5. Create data base - one row per USER. *** Each row is summarised data per user *** ----
#__________________________________________________________________________________________________________________________________
...
#6. Create data base - one row per IMPRESSION. *** response variable is whether that imp was attributed a last click conversion *** ----
#__________________________________________________________________________________________________________________________________
